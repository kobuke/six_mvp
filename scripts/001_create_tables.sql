...
drop policy if exists "Allow public to create rooms" on public.rooms;
...
drop policy if exists "Allow public to create messages" on public.messages;
drop policy if exists "Allow public to read messages in room" on public.messages;
drop policy if exists "Allow public to update messages" on public.messages;
drop policy if exists "Allow public to delete expired messages" on public.messages;
